...
const Notifications = () => {
  ...
  const basePath = "/retailer/notifications";
  ...
  return (
    <div className="notifications-page">
      ...
      <div className="notif-header">
        <h2 className="notif-title">Retailer Notifications</h2>
            ...
            return (
              <div key={n.id} className={`notif-card ${n.read ? "read" : "unread"}`}>
                <div className="notif-cell checkbox-cell">
                  <input type="checkbox" checked={selected} onChange={() => toggleSelect(n.id)} />
                </div>

                <div className="notif-cell avatar-cell">
                  <div className="avatar-circle">{(n.bidderFullName || "?").slice(0, 1).toUpperCase()}</div>
                </div>

                <div className="notif-cell name-cell">{n.bidderFullName || "Anonymous"}</div>
                ...
                <div className="notif-cell status-cell">{n.read ? "Read" : "Unread"}</div>

                <div className="notif-cell action-cell">
                  <button
                    className="details-btn"
                    onClick={() => {
                      navigate(`${basePath}/${n.id}`, { state: { notification: n } });
                    }}
                  >
                    Details
                  </button>
