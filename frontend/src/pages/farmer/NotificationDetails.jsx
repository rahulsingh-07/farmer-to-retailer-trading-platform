...
const NotificationDetails = () => {
  ...
  const typeUpper = (detail.type || "").toUpperCase();
  const canSell = statusUpper !== "ACTIVE" || typeUpper === "BID_WON";

  const handleSell = () => {
    if (!canSell) return;
    toast.success("Sell flow would start here.");
  };
    ...
    <div className="detail-container nd-container">
      ...
      <div className="detail-right nd-equal">
        ...
        <div className="nd-actions-row">
          <button type="button" className="nd-sell-btn" onClick={handleSell} disabled={!canSell}>
            Sell
          </button>
        </div>
